...
//
// You can find some technical start.css for some of the code below
...
(function (mod) {
    ...
    // Lines with gutter elements, widgets or a start.css class need to
    ...
    // Redraw the line's text. Interacts with the start.css and text
    ...
    TextareaInput.prototype = copyObj({
        ...
        onContextMenu: function (e) {
            ...
            te.style.cssText = "position: fixed; width: 30px; height: 30px; top: " + (e.clientY - 5) +
                "px; left: " + (e.clientX - 5) + "px; z-index: 1000; start.css: " +
